...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Location = System::Drawing::Point(246, 194);
			...
			this->label3->Location = System::Drawing::Point(222, 112);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"B Nazanin", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(178)));
			this->textBox1->Location = System::Drawing::Point(419, 122);
			...
			this->textBox2->Font = (gcnew System::Drawing::Font(L"B Nazanin", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(178)));
			this->textBox2->Location = System::Drawing::Point(419, 207);
			...
			this->button1->Location = System::Drawing::Point(419, 275);
			...
			this->button3->Font = (gcnew System::Drawing::Font(L"MS Reference Sans Serif", 24, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button3->Location = System::Drawing::Point(383, 419);
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"MS Reference Sans Serif", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(32, 470);
...
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	this->Hide();
	Project::Register_m^ RForm = gcnew Project::Register_m();
	RForm->ShowDialog();
	this->Show();
}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	else if (list::ManagerList.Count == 0) MessageBox::Show("No one has registered!");
	else {
		for (int i = 0; i < list::ManagerList.Count; i++) {
			if (list::ManagerList[i]->user_name == UserN) {
				if (list::ManagerList[i]->password == pass) {
					int j = i;
					this->Hide();
					Project::Manager_main^ mmgForm = gcnew Project::Manager_main(j);
					mmgForm->ShowDialog();
					this->Show();
					break;
				}
			...
			else if(i == list::ManagerList.Count-1) MessageBox::Show("No usernames found!");
		}
	}
